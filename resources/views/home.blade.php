...
@section('content')
    ...
    <div class=" md:container md:mx-auto lg:grid  justify-center py-2">
        <h2 class="mr-5 self-center font-normal">Sign up for Updates</h2>
        <form class="lg:m-4 flex lg:w-1/3 md:w-full" style="margin-top:1em;">
            <input class="w-full rounded-l-lg p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="your@mail.com"/>
            <button class="px-8 rounded-r-lg text-gray-800 font-bold p-4 uppercase border-t border-b border-r" style="background-color: #ff6e84;opacity: 0.9;" type="submit">Subscribe</button>
        </form>
    </div>
    <script>
