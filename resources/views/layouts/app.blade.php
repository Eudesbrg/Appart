    ...
    <footer class="px-4 divide-y bg-coolGray-100 text-coolGray-800">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div class="lg:w-1/3">
                <a href="#" class="flex justify-center space-x-3 lg:justify-start">
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-violet-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="flex-shrink-0 w-5 h-5 rounded-full text-coolGray-50">
            ...
            <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div class="space-y-3">
                    <h3 class="tracking-wide uppercase text-coolGray-900">Product</h3>
                    <ul class="space-y-1">
                        <li>
                            <a href="#">Features</a>
                        </li>
                ...
                <div class="space-y-3">
                    <h3 class="tracking-wide uppercase text-coolGray-900">Company</h3>
                    <ul class="space-y-1">
                        <li>
                            <a href="#">Privacy</a>
                        </li>
                ...
                <div class="space-y-3">
                    <h3 class="uppercase text-coolGray-900">Developers</h3>
                    <ul class="space-y-1">
                        <li>
                            <a href="#">Public API</a>
                        </li>
        ...
        <div class="py-6 text-sm text-center text-coolGray-600">© 1968 Company Co. All rights reserved.</div>
    </footer>
    <!-- end of footer -->
